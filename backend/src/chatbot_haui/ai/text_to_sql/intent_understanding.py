...
# =========================
# PATH (đường dẫn tương đối theo vị trí file, không còn hardcode máy cụ thể)
# =========================

DB_DESCRIPTION_PATH = Path(__file__).parent / "describe_DB.json"
STEP2_OUTPUT_PATH = Path(__file__).parent / "intent_understanding_output.json"
